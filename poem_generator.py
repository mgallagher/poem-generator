# 'Poem' Generator
# 
# This is a program that I adapted from a C++ school assignment. It reads in a text file of (ideally) a poem, counts how often each word occurs and also how often following words occur. A 'poem' is then generated by calling genereate_poem, which prints to the console a string of words of a user specified length that ends up sounding surprisingly similar to the original.
